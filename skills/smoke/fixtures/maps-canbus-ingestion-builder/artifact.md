# maps-canbus-ingestion-builder Artifact Fixture

Synthetic output used by smoke tests to verify output-contract coverage.

## CAN Requirement Mapping
Smoke placeholder for `CAN Requirement Mapping`.

## Interface Profile
Smoke placeholder for `Interface Profile`.
