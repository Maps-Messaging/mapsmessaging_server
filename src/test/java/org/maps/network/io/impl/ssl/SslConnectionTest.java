...
import org.maps.network.io.impl.ConnectionTest;

public class SslConnectionTest extends ConnectionTest {


  @Override
  protected EndPointConnectionFactory getFactory() {
    return new SSLEndPointConnectionFactory();
  }

  @Override
  protected EndPointURL getURL() {
    return new EndPointURL("ssl://localhost:8444");
  }
}