...
#include <jni.h>
/* Header for class io_mapsmessaging_network_io_impl_lora_device_LoRaDevice */

#ifndef _Included_io_mapsmessaging_network_io_impl_lora_device_LoRaDevice
#define _Included_io_mapsmessaging_network_io_impl_lora_device_LoRaDevice
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     io_mapsmessaging_network_io_impl_lora_device_LoRaDevice
 * Method:    init
 * Signature: (IFIII)I
 */
