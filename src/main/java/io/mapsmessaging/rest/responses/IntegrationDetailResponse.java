...
//  @ApiModelProperty(value="List of interfaces")
  private final List<IntegrationInfo> data;
  ...
  public IntegrationDetailResponse(HttpServletRequest request, List<IntegrationInfo> list, ConfigurationProperties map) {
    super(request);
    data = list;
    if(map != null) {
