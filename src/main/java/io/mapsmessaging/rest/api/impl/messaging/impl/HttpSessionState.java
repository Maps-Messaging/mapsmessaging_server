...
public class HttpSessionState {
  ...
  public HttpSessionState() {
    sessionStates = new ConcurrentHashMap<>();
  }
  ...
  public void setSessionState(String sessionId, SessionState sessionState) {
    sessionStates.put(sessionId, sessionState);
  }

  public SessionState removeSessionState(String sessionId) {
