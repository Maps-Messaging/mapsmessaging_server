...
public class OrbCommOgwsDTO  extends ProtocolConfigDTO {
  ...
  @Schema(description = "Client ID generated by OrbComm to use to communicate with the OGWS")
  protected String clientId;

  @Schema(description = "Client secret generated by OrbComm to use to communicate with the OGWS")
