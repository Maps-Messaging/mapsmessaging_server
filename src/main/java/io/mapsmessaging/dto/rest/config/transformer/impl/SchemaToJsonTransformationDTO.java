...
@Schema(
    title = "Schema To JSON Transformation",
...
public class SchemaToJsonTransformationDTO extends TransformationConfigDTO {

  public SchemaToJsonTransformationDTO() {
    super(TransformationType.SCHEMA_TO_JSON);
  }
}
