...
public class SystemStateReadinessCheck implements DroneTwinReadinessCheck {
  ...
  public void evaluate(
    ...
    if (droneTwin.getSystemState() == null) {
      evaluation.degraded(DroneTwinMissingState.MISSING_SYSTEM_STATE);
    }
  }
}