...
public class HomePositionReadinessCheck implements DroneTwinReadinessCheck {
  ...
  public void evaluate(
    ...
    if (droneTwin.getHomePosition() == null) {
      evaluation.degraded(DroneTwinMissingState.MISSING_HOME_POSITION);
    }
  }
}