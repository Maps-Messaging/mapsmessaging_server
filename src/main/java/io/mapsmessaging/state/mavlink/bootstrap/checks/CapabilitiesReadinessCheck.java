...
public class CapabilitiesReadinessCheck implements DroneTwinReadinessCheck {
  ...
  public void evaluate(
    ...
    if (autopilotState == null || autopilotState.getCapabilities() == null) {
      evaluation.degraded(DroneTwinMissingState.MISSING_CAPABILITIES);
    }
  }
}