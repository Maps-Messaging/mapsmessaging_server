...
public interface UavModel extends UxvModel {

    default UxvModelCommandSet takeOff(UxvCommandContext context, double altitudeMeters) {
        throw unsupported(UxvOperation.TAKE_OFF);
    }

    default UxvModelCommandSet land(UxvCommandContext context) {
        throw unsupported(UxvOperation.LAND);
    }

    default UxvModelCommandSet setAltitude(UxvCommandContext context, double altitudeMeters) {
