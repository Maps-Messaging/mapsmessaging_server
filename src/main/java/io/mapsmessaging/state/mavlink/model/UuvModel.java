...
public interface UuvModel extends UxvModel {

    default UxvModelCommandSet dive(UxvCommandContext context, double depthMeters) {
        throw unsupported(UxvOperation.DIVE);
    }

    default UxvModelCommandSet surface(UxvCommandContext context) {
        throw unsupported(UxvOperation.SURFACE);
    }

    default UxvModelCommandSet setDepth(UxvCommandContext context, double depthMeters) {
        throw unsupported(UxvOperation.SET_DEPTH);
    }

    default UxvModelCommandSet holdDepth(UxvCommandContext context, double depthMeters) {
