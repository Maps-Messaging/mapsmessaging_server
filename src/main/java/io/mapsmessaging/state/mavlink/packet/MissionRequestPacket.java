...
/**
 * MAVLink MISSION_REQUEST mapped to a typed packet.
 */
@Getter
public final class MissionRequestPacket extends MavlinkPacket {
  ...
  public MissionRequestPacket(ProcessedFrame frame) {
