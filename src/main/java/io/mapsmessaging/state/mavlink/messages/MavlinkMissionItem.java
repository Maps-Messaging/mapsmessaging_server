...
@NoArgsConstructor
@AllArgsConstructor
public class MavlinkMissionItem implements MavlinkMessage {

  public static final int MESSAGE_ID_MISSION_ITEM = 39;

  private String messageType = "MISSION_ITEM";
  private int messageId = MESSAGE_ID_MISSION_ITEM;
