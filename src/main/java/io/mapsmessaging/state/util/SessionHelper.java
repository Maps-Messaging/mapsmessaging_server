...
public class SessionHelper {
  ...
  public static StateLoopProtocol createLoopbackProtocol(MessageHandler messageHandler){
    return  new StateLoopProtocol(new NoOpEndPoint(sessionCounter.incrementAndGet(), null, new ArrayList<>()), messageHandler);
  }
