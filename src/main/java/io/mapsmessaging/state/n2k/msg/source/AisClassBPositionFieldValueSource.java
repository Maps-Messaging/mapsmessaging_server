...
public class AisClassBPositionFieldValueSource implements FieldValueSource {
  ...
  private static final String RAIM = "raimflag";
  private static final String TIME_STAMP = "timeStamp";
  private static final String COG = "cog";
  private static final String SOG = "sog";
  private static final String COMMUNICATION_STATE_INFORMATION = "communicationState";
  private static final String AIS_TRANSCEIVER_INFORMATION = "aisTransceiverInformation";
  private static final String HEADING = "trueHeading";
  ...
  private static final String UNIT_TYPE = "classBUnitFlag";
  private static final String INTEGRATED_DISPLAY = "classBDisplayFlag";
  private static final String DSC = "classBDscFlag";
  private static final String BAND = "classBBandFlag";
  private static final String CAN_HANDLE_MSG_22 = "classBMsg22Flag";
  private static final String AIS_MODE = "modeFlag";
  private static final String AIS_COMMUNICATION_STATE = "communicationStateSelectorFlag";
