...
public class CloudEventJsonTransformationConfig extends CloudEventJsonTransformationDTO {

  public CloudEventJsonTransformationConfig(ConfigurationProperties props) {
    setType(TransformationType.CLOUD_EVENT_JSON);
  }
}
