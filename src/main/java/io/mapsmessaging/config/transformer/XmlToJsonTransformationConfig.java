...
public class XmlToJsonTransformationConfig extends XmlToJsonTransformationDTO {

  public XmlToJsonTransformationConfig(ConfigurationProperties props) {
    setType(TransformationType.XML_TO_JSON);
  }
}
