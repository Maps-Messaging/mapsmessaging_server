...
public class JsonToXmlTransformationConfig extends JsonToXmlTransformationDTO {

  public JsonToXmlTransformationConfig(ConfigurationProperties props) {
    setType(TransformationType.JSON_TO_XML);
  }
}
