...
public class OrbcommOgwsEndPoint extends EndPoint {

  @Getter
  private final TerminalInfo terminalInfo;

  protected OrbcommOgwsEndPoint(long id, EndPointServerStatus server, TerminalInfo terminal) {
    super(id, server);
  ...
  public void sendMessage(SubmitMessage submitMessage) {
    ((OrbCommOgwsEndPointServer) server).sendClientMessage(terminalInfo.getPrimeId(), submitMessage);
  }
