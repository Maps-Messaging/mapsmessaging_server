...
import io.mapsmessaging.network.protocol.impl.nats.jetstream.stream.handlers.data.StreamNamesResponse;
...
public class StreamNamesHandler extends JetStreamHandler {
  @Override
