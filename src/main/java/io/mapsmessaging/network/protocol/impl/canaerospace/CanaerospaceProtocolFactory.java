...
public class CanaerospaceProtocolFactory extends ProtocolImplFactory {

  public CanaerospaceProtocolFactory() {
    super("canaerospace", "CanAerospace Protocol", null);
  }
  ...
  public void create(EndPoint endPoint, InterfaceInformation info) throws IOException {
    if(endPoint instanceof CanbusEndPoint canbusEndPoint) {
      new CanaerospaceProtocol(canbusEndPoint, endPoint.getConfig().getProtocolConfig("canaerospace"));
    }
  }
