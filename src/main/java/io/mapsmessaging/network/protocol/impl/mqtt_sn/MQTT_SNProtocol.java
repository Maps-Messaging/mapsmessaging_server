...
import io.mapsmessaging.network.protocol.impl.mqtt_sn.packet.PingRequest;
...
import io.mapsmessaging.network.protocol.impl.mqtt_sn.state.InitialConnectionState;
