...
public class RetainAvailable extends BooleanMessageProperty {

  RetainAvailable() {
    super(MessagePropertyFactory.RETAIN_AVAILABLE, "RetainAvailable");
  }

  public RetainAvailable(boolean val) {
    this();
    value = val;
  }
