...
public abstract class IntegerMessageProperty extends MessageProperty {

  protected long value;

  protected IntegerMessageProperty(int id, String name) {
    super(id, name);
  }

  @Override
  public void load(Packet packet) {
    value = MQTTPacket.readInt(packet);
  }
