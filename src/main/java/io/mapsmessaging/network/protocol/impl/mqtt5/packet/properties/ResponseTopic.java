...
public class ResponseTopic extends UTF8MessageProperty {

  ResponseTopic() {
    super(MessagePropertyFactory.RESPONSE_TOPIC, "ResponseTopic");
  }

  public ResponseTopic(String responseTopic) {
    super(MessagePropertyFactory.RESPONSE_TOPIC, "ResponseTopic");
  ...
  public String getResponseTopicString() {
    return value;
  }

  public void setResponseTopic(String value) {
    this.value = value;
  }
}
