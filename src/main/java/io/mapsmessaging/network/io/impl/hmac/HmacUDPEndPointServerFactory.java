...
public class HmacUDPEndPointServerFactory implements EndPointServerFactory {
  ...
  public EndPointServer instance(
    ...
    ProtocolFactory protocolFactory = new ProtocolFactory(endPointServerConfig.getProtocols());
    return new HmacUDPEndPointServer(inetSocketAddress, protocolFactory, url, selector, managerMBean, endPointServerConfig);
  }
