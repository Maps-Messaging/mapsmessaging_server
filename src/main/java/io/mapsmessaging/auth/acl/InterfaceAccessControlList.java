...
public class InterfaceAccessControlList extends BaseAccessControlList {
  ...
  public InterfaceAccessControlList() {
  }

  public InterfaceAccessControlList(List<AclEntry> aclEntries) {
    super(aclEntries);
  }
  ...
  public AccessControlList create(AccessControlMapping accessControlMapping, List<String> config) {
    ...
    return new InterfaceAccessControlList(parser.createList(accessControlMapping, config));
  }
