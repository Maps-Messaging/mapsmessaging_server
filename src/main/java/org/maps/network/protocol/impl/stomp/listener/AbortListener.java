...
public class AbortListener implements ClientFrameListener {

  @Override
  public void frameEvent(ClientFrame frame, StateEngine engine, boolean endOfBuffer) throws StompProtocolException {
