...
public abstract class BaseEventListener implements EventListener {
  ...
  protected org.maps.network.protocol.impl.amqp.SessionManager createOrReuseSession(Connection connection) throws LoginException, IOException {
    String sessionId = parseSessionId(connection.getRemoteContainer());
    org.maps.network.protocol.impl.amqp.SessionManager sessionManager = protocol.getSession(sessionId);
