...
public class GreaterOrEqualOperator extends ComparisonOperator {

  public GreaterOrEqualOperator(Object lhs, Object rhs) {
    super(lhs, rhs);
  }
  ...
  public boolean equals(Object test){
    if(test instanceof GreaterOrEqualOperator){
      return (lhs.equals(((GreaterOrEqualOperator) test).lhs) && rhs.equals(((GreaterOrEqualOperator) test).rhs));
    }
    return false;
  }
